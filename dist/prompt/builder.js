...
export async function buildEvalRequest(filePath, compact = false, includeCandidatePaths = false) {
...
export async function buildCompareRequest(fileA, fileB) {
...
export async function buildDoomRequest(input, compact = false) {
    let document = input;
    try {
        await access(input);
