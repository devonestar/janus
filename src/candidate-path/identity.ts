import type { CandidatePath, JanusOutput } from "../types.js";
...
function normalizeCandidatePath(path: CandidatePath): CandidatePath {
  return {
    ...path,
...
export function normalizeCandidatePaths(output: JanusOutput): JanusOutput {
...
export function suppressCandidatePaths(output: JanusOutput): JanusOutput {
